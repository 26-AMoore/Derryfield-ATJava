...
public class PartC {
    public static void main(String[] args) throws Exception {
        ...
        int num = in.nextInt(); //Forgot to add parentheses and Int

        // calculate the cost before discount.
        double cost = num * COST_OF_COOKIE;

        // Use conditional statements to determine what discount is.
        double discount = 0; //forgot to initialize
			
        if (num > 24) { //Had to reverse these or any num > 6 makes discount 0.025
            discount = 0.15;
        } else if (num > 12) {
            discount = 0.05;
		}else if (num > 6) {
